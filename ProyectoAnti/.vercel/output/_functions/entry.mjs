...
import { $ as clientAddressSymbol, A as isRenderInstruction, B as isRoute404, C as renderSlotToString, G as createAsyncManifestMemo, H as getErrorRoutePath, I as getCustom404Route, J as AstroIntegrationLogger, K as createManifestMemo, L as getCustom500Route, M as pushDirective, P as renderEndpoint, Q as REROUTABLE_STATUS_CODES, R as getDefaultStatusCode, U as BodySizeLimitError, V as isRoute500, W as readBodyWithLimit, X as ASTRO_GENERATOR, Y as ASTRO_ERROR_HEADER, Z as REDIRECT_STATUS_CODES, a as getRouteCache, at as pathHasLocale, c as getResolvedLogger, ct as appendForwardSlash, d as getOriginPathname, dt as hasFileExtension, et as fetchStateSymbol, f as setOriginPathname, ft as isInternalPath, g as SERVER_ISLAND_COMPONENT, gt as removeLeadingForwardSlash, h as DEFAULT_404_ROUTE, ht as prependForwardSlash, i as getProps, it as normalizeThePath, j as normalizeCspResourceEntry, l as getEnvironment, lt as collapseDuplicateSlashes, m as validateAndDecodePathname, mt as joinPaths, n as defineMiddleware, nt as responseSentSymbol$1, o as getRouteGenerator, ot as decodeKey, p as MultiLevelEncodingError, q as shouldAppendForwardSlash, r as getParams, rt as normalizeTheLocale, s as getLogger, st as generateCspDigest, t as sequence, tt as originPathnameSymbol, u as copyRequest, ut as collapseDuplicateTrailingSlashes, v as renderPage, vt as removeTrailingForwardSlash, w as isRenderTemplateResult, x as chunkToString, y as renderJSX, yt as stripRequestBase, z as routeHasHtmlExtension } from "./chunks/sequence_CYEvADDU.mjs";
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"MODE": "production",
			"PROD": true,
			"PUBLIC_SUPABASE_ANON_KEY": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVleXp4Y3FvdW5pcXFobGdhcnNvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODc1OTE3NTIsImV4cCI6MjEwMzE2Nzc1Mn0.t0l6ylyNVEjqTo-GzrzWA_IsawhqvYvn3zdUU239vv8",
			"PUBLIC_SUPABASE_URL": "https://ueyzxcqouniqqhlgarso.supabase.co",
			"SITE": void 0,
			"SSR": true
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/auth/forgot-password.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/auth/google.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/auth/signup.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/auth\\/update-password\\/?$",
			"segments": [
				[{
					"content": "api",
					"dynamic": false,
			...
			"params": [],
			"component": "src/pages/api/auth/update-password.ts",
